function uppg10(){
    ...
    const result = categorizeNumbers(numbers);
    console.log(result); // Skriv ut resultatet i konsolen  
    return result; // Returnera resultatet som ett objekt med de tre arrayerna  
